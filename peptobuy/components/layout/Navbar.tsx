...
function FlashSaleCountdown() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline">· 🎁 Free BAC Water Voucher with every order · 🔥 RTGLP3 — Very Low Stock · Act Fast · Free GHK-Cu on orders $250+ (<span style={{ background: "#fff", color: "#cc0000", borderRadius: "4px", padding: "0 4px", fontWeight: 900, fontSize: "11px" }}>Only 3 Left!</span>)</span>
    </div>
  );
}
